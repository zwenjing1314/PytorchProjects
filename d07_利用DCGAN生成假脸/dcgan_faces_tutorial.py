...
def main():
    ...
    torch.save(netG_to_save.state_dict(), "netG.pth")
    torch.save(netD_to_save.state_dict(), "netD.pth")
    print("Saved generator weights to netG.pth and discriminator weights to netD.pth")
