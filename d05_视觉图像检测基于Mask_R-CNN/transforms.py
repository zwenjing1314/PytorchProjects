...
def _copy_paste(
    ...
    # We resize source and paste datas if they have different sizes
    # This is something we introduced here as originally the algorithm works
    # on equal-sized datas (for example, coming from LSJ datas augmentations)
    size1 = image.shape[-2:]
...
class SimpleCopyPaste(torch.nn.Module):
    ...
    def forward(
        ...
        # FYI: in TF they mix datas on the dataset level
